...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      component: () => import('@/views/pm/declareInStock/inStockRecord.vue')
    },
    {
    ...
    // },
    {
      path: 'progress-projcet-task-delete',
      name: 'progress-projcet',
      meta: [{
        name: '任务删除记录',
        parentName: '项目管理',
      ...
      component: () => import('@/views/pm/progressProjcet/taskDeleteTable.vue')
    },
    {
    ...
    {
      path: 'progress-projcet-fund-delete',
      name: 'progress-projcet',
      meta: [{
        name: '经费报销删除记录',
        parentName: '项目管理',
      ...
      component: () => import('@/views/pm/progressProjcet/fundDeleteTable.vue')
    },
    {
    ...
    {
      path: 'progress-projcet-results-delete',
      name: 'progress-projcet',
      meta: [{
        name: '成果信息删除记录',
        parentName: '项目管理',
      ...
      component: () => import('@/views/pm/progressProjcet/outDeleteTable.vue')
    },
    {
