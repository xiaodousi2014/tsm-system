...
export default {
 ...
 children: [
  ...
  },
  {
   ...
   component: () => import('@/views/textbookManager/inStockRegister/index.vue')
  },

  {
   ...
   component: () => import('@/views/textbookManager/storageEquipment/index.vue')
  },

  {
   ...
   component: () => import('@/views/textbookManager/receiveRecord/index.vue')
  },

  {
   ...
   component: () => import('@/views/textbookManager/receiveExamine/index.vue')
  },

  {
   ...
   component: () => import('@/views/textbookManager/borrowRecord/index.vue')
  },
  {
   path: 'borrow-examine',
...

  {
   ...
   component: () => import('@/views/textbookManager/scrapRecord/index.vue')
  },
  {
   path: 'scrap-examine',
   name: 'teaching-material-manage-scrap-examine',
   meta: [{name: '报废审核', parentName: '教材管理', path: '/declare-in-stock'}],
   component: () => import('@/views/textbookManager/scrapExamine/index.vue')
  },

  {
   ...
   component: () => import('@/views/textbookManager/inventoryJournal/index.vue')
  },
  {
   path: 'maintain-manage',
   name: 'teaching-material-manage-maintain-manage',
   meta: [{name: '维护管理', parentName: '教材管理', path: '/declare-in-stock'}],
   component: () => import('@/views/textbookManager/maintainManage/index.vue')
  },
 ]
}
