<template>
  <div>
    <div class="top-menu">
      <span style="font-size: 20px;font-weight:900;">教员管理</span>
...
//检索
// import RuleForm from "@/views/doc/components/ruleForm.vue";
import RuleForm from "../../../views/doc/components/ruleForm.vue";
  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: "教员号", prop: "c", width: "" }, 
        { label: "学院（专业系）代码", prop: "e", width: "" },
        { label: "文化程度", prop: "f", width: "" },
        { label: "学位代码", prop: "g", width: "" },
        { label: "性别", prop: "x", width: "" },
