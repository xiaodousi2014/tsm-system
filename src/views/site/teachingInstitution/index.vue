...
export default {
    ...
    data() {
        return {
            ...
            fileUrl: '',
            fileUrl: 'http://27.210.124.225:8190/common/import?infoType=d_teach_org',
            searchModal: false,
    ...
    methods: {
        ...
        // 导入
        onUploadFile() {
            ;(this.fileUrl = 'http://27.210.124.225:8190/common/import?infoType=d_teach_org'), (this.exportModal = true)
        },
        close() {
        ...
        listCreate(event) {
            event.t_training_base = 'd_teach_org'
            event.site_type = 'd_teach_org'
            event.base_name = ''
            Http.addData(event)
                .then((res) => {
                    if (res.code == '0000') {
        ...
        onExport() {
            ...
            window.open(`http://24992uu588.qicp.vip:80/common/export?ids=${this.multipleSelection.toString()}&&infoType=d_teach_org`)
        },
    },
    created() {},
}
