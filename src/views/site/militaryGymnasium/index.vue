...
export default {
    ...
    data() {
        return {
            ...
            fileUrl: '',
            fileUrl: 'http://27.210.124.225:8190/common/import?infoType=d_military_sports_hall',
            searchModal: false,
    ...
    methods: {
        ...
        onRevoke() {
            ...
            Http.revokeOperation({
                ...
                site_type: 'd_military_sports_hall',
            })
                .then((res) => {
                    if (res.code == '0000') {
        ...
        // 导入
        onUploadFile() {
            ;(this.fileUrl = 'http://27.210.124.225:8190/common/import?infoType=d_military_sports_hall'), (this.exportModal = true)
        },
        close() {
        ...
        listCreate(event) {
            event.t_training_base = 'd_military_sports_hall'
            event.site_type = 'd_military_sports_hall'
            event.base_name = ''
            Http.addData(event)
                .then((res) => {
                    if (res.code == '0000') {
        ...
        listEdit() {
            ...
            params.site_type = 'd_military_sports_hall'
        ...
        onExport() {
            ...
            window.open(`http://24992uu588.qicp.vip:80/common/export?ids=${this.multipleSelection.toString()}&&infoType=d_military_sports_hall`)
        },
    },
    created() {},
}
