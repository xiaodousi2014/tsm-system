<template>
  <div class="user_plan">
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      <el-tab-pane label="实验人员" name="day">
        <div class="user_plan_day">
          <div class="user_plan_day_btn">
            ...
            <el-button type="primary" size="small" @click="dayListTable()"
              >列表显示</el-button
            >
            <el-button
              type="primary"
              size="small"
              @click="dayListTable('default')"
              >汇总图显示</el-button
            >
          </div>
      ...
      <el-tab-pane label="周计划" name="week">
        <div class="user_plan_week">
          <div class="user_plan_day_default_table" v-if="defaultTableShow">
            ...
            >
              <el-table-column prop="a" label="使用场地" width="180">
              </el-table-column>
              ...
              <el-table-column prop="i" label="本周使用时间（H）">
              </el-table-column>
            </el-table>
          </div>
        </div>
    ...
    >
      <el-form ref="form" :inline="true" :model="form" label-width="150px">
        <el-form-item
          :label="item.name"
          v-for="(item, index) in tableAllIist"
          :key="index"
        >
          ...
          <el-row v-if="item.type == 'time'">
            ...
            <el-col style="text-align: center;" class="line" :span="1"
              >-</el-col
            >
            <el-col :span="11">
              <el-time-picker
