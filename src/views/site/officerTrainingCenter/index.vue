...
export default {
    ...
    data() {
        return {
            ...
            fileUrl: '',
            fileUrl: 'http://27.210.124.225:8190/common/import?infoType=d_officer_centre',
            searchModal: false,
    ...
    methods: {
        ...
        // 导入
        onUploadFile() {
            ;(this.fileUrl = 'http://27.210.124.225:8190/common/import?infoType=d_officer_centre'), (this.exportModal = true)
        },
        close() {
        ...
        listCreate(event) {
            event.t_training_base = 'd_officer_centre'
            event.site_type = 'd_officer_centre'
            event.base_name = ''
            Http.addData(event)
                .then((res) => {
                    if (res.code == '0000') {
        ...
        listEdit() {
            ...
            params.site_type = 'd_officer_centre'
        ...
        onExport() {
            ...
            window.open(`http://24992uu588.qicp.vip:80/common/export?ids=${this.multipleSelection.toString()}&&infoType=d_officer_centre`)
        },
    },
    created() {},
}
