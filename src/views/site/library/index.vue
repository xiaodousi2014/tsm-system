...
export default {
    ...
    data() {
        return {
            ...
            fileUrl: '',
            fileUrl: 'http://27.210.230.34:8190/common/import?infoType=d_library',
            searchModal: false,
    ...
    methods: {
        ...
        // 导入
        onUploadFile() {
            ;(this.fileUrl = 'http://27.210.230.34:8190/common/import?infoType=d_library'), (this.exportModal = true)
        },
        close() {
