...
export default {
    ...
    data() {
        return {
            ...
            fileUrl: '',
            fileUrl: 'http://27.210.230.34:8190/common/import?infoType=d_studio',
            searchModal: false,
    ...
    methods: {
        ...
        // 导入
        onUploadFile() {
            ;(this.fileUrl = 'http://27.210.230.34:8190/common/import?infoType=d_studio'), (this.exportModal = true)
        },
        close() {
