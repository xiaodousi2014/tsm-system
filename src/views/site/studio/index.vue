...
export default {
    ...
    data() {
        return {
            ...
            fileUrl: '',
            fileUrl: 'http://27.210.124.225:8190/common/import?infoType=d_studio',
            searchModal: false,
    ...
    methods: {
        ...
        // 导入
        onUploadFile() {
            ;(this.fileUrl = 'http://27.210.124.225:8190/common/import?infoType=d_studio'), (this.exportModal = true)
        },
        close() {
        ...
        listCreate(event) {
            event.t_training_base = 'd_studio'
            event.site_type = 'd_studio'
            event.base_name = ''
            Http.addData(event)
                .then((res) => {
                    if (res.code == '0000') {
        ...
        onExport() {
            ...
            window.open(`http://24992uu588.qicp.vip:80/common/export?ids=${this.multipleSelection.toString()}&&infoType=d_studio`)
        },
    },
    created() {},
}
