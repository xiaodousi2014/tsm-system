...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: "http://10.8.145.43:8190/material/import",
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
    onTemplateDown() {
      window.open('http://10.8.145.43:8190/common/attachment/download_TemplateFile?infoType=t_material')
    },
     getAttachFile(query) {
    ...
    onUpload() {
      (this.fileUrl = "http://10.8.145.43:8190/material/import"),
