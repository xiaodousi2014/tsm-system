...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `http://139.198.188.175:8190/common/attachment/import?infoType=t_material&id=${this.multipleSelection[0]}`;
    ...
    onExport() {
      if (!this.multipleSelection.length) {
       ...
       window.open(`http://139.198.188.175:8190/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_material`)
