<template>
  <div class="manage">
    ...
    <el-container class="main-container">
      ...
      <el-header>
        <div class="user-box">
          ...
          <span>测试账号</span>
          <span style="padding-right: 10px">2020.11.11 15:20 </span>
          <el-button size="mini" @click="onReturn">退出</el-button>
        </div>
    ...
    <el-dialog title="修改密码" :visible.sync="modificationDialog" inline-message width="25%">
      <el-form
    ...
    <el-dialog title="温馨提示" :visible.sync="logoutDialog" inline-message width="20%">
