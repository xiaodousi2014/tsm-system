...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: `${window.upLoadUrl}/material/import`,
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
    onTemplateDown() {
      window.open(`${window.upLoadUrl}/common/attachment/download_TemplateFile?infoType=t_material`)
    },
     getAttachFile(query) {
    ...
    onUpload() {
      (this.fileUrl = "${window.upLoadUrl}/material/import"),
