...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: `${process.env.VUE_APP_API_URL}/material/import`,
  ...
  methods: {
    ...
    onTemplateDown() {
      window.open(`${process.env.VUE_APP_API_URL}/common/attachment/download_TemplateFile?infoType=t_material`)
    },
     getAttachFile(query) {
