...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${process.env.VUE_APP_API_URL}/common/attachment/import?infoType=t_material&id=${this.dataList.id}`;
    ...
    onExport() {
      if (!this.multipleSelection.length) {
       ...
       window.open(`${process.env.VUE_APP_API_URL}/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_material`)
