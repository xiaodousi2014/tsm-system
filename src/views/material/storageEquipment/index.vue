...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${window.upLoadUrl}/common/attachment/import?infoType=t_material&id=${this.multipleSelection[0]}`;
    ...
    onExport() {
      if (!this.multipleSelection.length) {
       ...
       window.open(`${window.upLoadUrl}/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_material`)
