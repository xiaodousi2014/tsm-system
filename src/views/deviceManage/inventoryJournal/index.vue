...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `http://10.8.145.43:8190/common/attachment/import?infoType=t_device_check&id=${this.multipleSelection[0].id}`;
    ...
    onExport() {
      ...
      window.open(`http://10.8.145.43:8190/device/check/export?id=${this.multipleSelection[0].id}`)
