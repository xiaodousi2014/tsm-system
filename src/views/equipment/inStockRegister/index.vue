...
export default {
  ...
  data() {
    return {
      ...
      dataList: {},
      fileUrl: `${window.upLoadUrl}/equipment/import`,
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
    onTemplateDown() {
      window.open(`${window.upLoadUrl}/common/attachment/download_TemplateFile?infoType=t_equipment`)
    },
     getAttachFile(query) {
    ...
    onUpload() {
      this.fileUrl = `${window.upLoadUrl}/equipment/import`,
