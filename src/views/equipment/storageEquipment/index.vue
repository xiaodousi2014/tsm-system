          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="设备名称:" prop="manufacturer">
                <el-input
                  disabled
                  v-model.trim="item.equipment_name"
                  maxlength="10"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="请领数量:" prop="equipmentModel">
                <el-input
                  disabled
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="维修项目名称:" prop="manufacturer">
              <el-input
                disabled
                v-model.trim="repairList[0].equipment_name"
                maxlength="10"
              ></el-input>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
     getAttachFile(query) {
      ...
      Http.getAttachFile({id:query.row.id, infoType: "t_equipment" , file: query.file})
      .then((res) => {
    ...
    onEdit() {
      ...
      this.fileUrl = `${process.env.VUE_APP_API_URL}/common/attachment/import?infoType=t_equipment&id=${this.multipleSelection[0]}`;
      this.editModal = true;
    },
    listEdit() {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${process.env.VUE_APP_API_URL}/common/uploadfile?infoType=t_equipment&&id=${this.dataList.id}`;
    ...
    onExport() {
      ...
      window.open(`${process.env.VUE_APP_API_URL}/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_equipment`)
    },
    // 报废
    async onScrap() {
      if (!this.multipleSelection.length) {
