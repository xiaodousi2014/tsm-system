...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${process.env.VUE_APP_API_URL}/common/uploadfile?infoType=t_equipment_check&isAttachment=1&isMultiFiles=true&field=attachment&&id=${this.multipleSelection[0].id}`;
