...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: `${window.upLoadUrl}/information/electronic/import`,
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
    onTemplateDown() {
      window.open(`${window.upLoadUrl}/common/attachment/download_TemplateFile?infoType=t_information_electronic`)
    },
     getAttachFile(query) {
   ...
   // 上传附件
    ...
    onUpload() {
      this.fileUrl = `${window.upLoadUrl}/information/electronic/import`,
