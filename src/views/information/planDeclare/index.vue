...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportModal: false,
      fileUrl: `${process.env.VUE_APP_API_URL}/information/plan/import`,
      searchModal: false,
      preferencesModal:false,
      infoType: 't_information_plan',
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
     getAttachFile(query) {
      ...
      Http.getAttachFile({id:query.row.id, infoType: "t_information_plan" , file: query.file})
      .then((res) => {
