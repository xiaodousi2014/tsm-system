<template>
  <div class="ClassifiedDisplay padding20">
    ...
    <div style="text-align: right;">
      ...
      <el-button type="primary" @click="onUploadFileOther()"
        >上传附件</el-button
      >
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: '',
      fileUrl:
        'http://27.210.124.225:8190/common/import?infoType=d_training_base',
      searchModal: false,
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = 'http://27.210.124.225:8190/common/import?infoType=d_training_base',
    ...
    onExport() {
      ...
      window.open(
        `http://10.8.145.43:8190/common/export?ids=${this.multipleSelection.toString()}&&infoType=d_training_base`
      )
    },
  },
  created() {},
