...
export default {
  ...
  methods: {
    ...
    onExport() {
      ...
      window.open(`${process.env.VUE_APP_API_URL}/common/attachment/export?ids=${query.toString()}&&infoType=t_maps_lent`)

    },
     getAttachFile(query) {
       const link = document.createElement("a");
      Http.getAttachFile({id:query.row.id, infoType: "t_maps_lent" , file: query.file})
      .then((res) => {
