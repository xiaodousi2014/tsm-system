...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${window.upLoadUrl}/common/attachment/import?infoType=t_maps_check&id=${this.multipleSelection[0].id}`;
    ...
    onExport() {
      ...
      window.open(`${window.upLoadUrl}/maps/check/export?id=${this.multipleSelection[0].id}`)
