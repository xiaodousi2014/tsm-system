...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${process.env.VUE_APP_API_URL}/common/attachment/import?infoType=t_stationery&id=${this.dataList.id}`;
    ...
    onExport() {
      ...
      window.open(`${process.env.VUE_APP_API_URL}/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_stationery`)
    },
    // 报废
    // async onScrap() {
    //   if (!this.multipleSelection.length) {
