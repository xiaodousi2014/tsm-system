...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${process.env.VUE_APP_API_URL}/common/attachment/import?infoType=t_stationery_check&id=${this.multipleSelection[0].id}`;
    ...
    onExport() {
      ...
      window.open(`${process.env.VUE_APP_API_URL}/stationery/check/export?id=${this.multipleSelection[0].id}`)
