...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: `${process.env.VUE_APP_API_URL}/stationery/import`,
  ...
  methods: {
     ...
     onTemplateDown() {
      window.open(`${process.env.VUE_APP_API_URL}/common/attachment/download_TemplateFile?infoType=t_stationery`)
    },
    getAttachFile(query) {
   ...
   // 上传附件
    ...
    onUpload() {
      this.fileUrl = `${process.env.VUE_APP_API_URL}/stationery/import`,
