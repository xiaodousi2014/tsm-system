...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${window.upLoadUrl}/common/attachment/import?infoType=t_stationery_check&id=${this.multipleSelection[0].id}`;
    ...
    onExport() {
      ...
      window.open(`${window.upLoadUrl}/stationery/check/export?id=${this.multipleSelection[0].id}`)
