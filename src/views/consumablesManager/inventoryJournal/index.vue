...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `http://139.198.188.175:8190/common/attachment/import?infoType=t_stationery_check&id=${this.multipleSelection[0].id}`;
    ...
    onExport() {
      ...
      window.open(`http://139.198.188.175:8190/stationery/check/export?id=${this.multipleSelection[0].id}`)
