    ...
    <el-dialog :title="title" :visible.sync="addInfoModal" width="1024px">
      <div v-for="item in form" :key="item.id">
        ...
        >
          <el-row>
            <el-col :span="8">
              <el-form-item label="易耗品名称:" prop="manufacturer">
                <el-input
                  disabled
                  v-model.trim="item.stationery_name"
                  maxlength="10"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="请领数量:" prop="stationeryModel">
                <el-input
      ...
      <div v-for="item in borrowList" :key="item.id">
        ...
        >
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="借用数量:" prop="stationeryModel">
                <el-input
                  v-model.trim="item.quantity"
                  maxlength="30"
       ...
       <div v-for="item in repairList" :key="item.id">
        ...
        >
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="报废数量:" prop="stationeryModel">
                <el-input
                  v-model.trim="item.quantity"
                  maxlength="30"
                  @change="changeNumber($event,item)"
...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `http://139.198.188.175:8190/common/attachment/import?infoType=t_stationery&id=${this.multipleSelection[0]}`;
    ...
    onExport() {
      ...
      window.open(`http://139.198.188.175:8190/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_stationery`)
    },
    // 报废
    // async onScrap() {
    //   if (!this.multipleSelection.length) {
