...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `${window.upLoadUrl}/common/attachment/import?infoType=t_stationery&id=${this.multipleSelection[0]}`;
    ...
    onExport() {
      ...
      window.open(`${window.upLoadUrl}/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_stationery`)
    },
    // 报废
    // async onScrap() {
    //   if (!this.multipleSelection.length) {
