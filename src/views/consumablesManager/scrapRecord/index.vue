...
export default {
  ...
  methods: {
    getAttachFile(query) {
      ...
      Http.getAttachFile({id:query.row.id, infoType: "t_stationery_abolish" , file: query.file})
      .then((res) => {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `http://139.198.188.175:8190/common/attachment/import?infoType=t_stationery_abolish&id=${this.multipleSelection[0].id}`;
