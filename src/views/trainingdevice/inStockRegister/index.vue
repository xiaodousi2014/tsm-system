...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      // this.fileUrl = `${process.env.VUE_APP_API_URL}/common/uploadfile?infoType=t_import_record&isAttachment=0&isMultiFiles=true&field=data_record&id=${this.dataList.id}`;     
    ...
    onUpload() {
      this.fileUrl = `${process.env.VUE_APP_API_URL}/trainingdevice/import`,
