...
export default {
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      // this.fileUrl = `${process.env.VUE_APP_API_URL}/common/attachment/import?infoType=t_trainingdevice&id=${this.dataList.id}`;
      this.fileUrl = `${process.env.VUE_APP_API_URL}/common/attachment/import?infoType=t_trainingdevice_abolish&id=${this.dataList.id}`;
