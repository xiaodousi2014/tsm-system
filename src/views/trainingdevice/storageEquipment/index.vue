<template>
    <div class="ClassifiedDisplay padding20">
        ...
        <div class="table-button">
            ...
            <el-button class="btnSty" @click="onRevoke()">删除记录</el-button>
            <!-- <el-button class="btnSty" @click="onQingLing()"
        >请领</el-button
      > -->
            <el-button class="btnSty" @click="onBorrow()">借用</el-button>
            <el-button class="btnSty" @click="onRepair()">维修</el-button>
            <el-button class="btnSty" @click="onScrap()">报废</el-button>
            <el-button class="btnSty" @click="onExport()">导出</el-button>
            <el-button class="btnSty" @click="onInventory()">盘点</el-button>
            <el-button type="primary" @click="onUploadFile()">上传附件</el-button>
            <el-button class="btnSty" @click="onCanBorrow()">设置可借</el-button>
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="设备名称:" prop="manufacturer">
                                <el-input disabled v-model.trim="item.device_name" maxlength="10"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="请领数量:" prop="trainingdeviceModel">
                                <el-input disabled v-model.trim="item.quantity" maxlength="30"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="申请人:" prop="costAmount">
                                <el-input disabled v-model.trim="item.receiver" maxlength="10"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="存放地点:" prop="costAmount">
                                <el-input v-model.trim="item.locate_site" maxlength="10"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="联系方式:" prop="costAmount">
                                <el-input v-model.trim="item.receiver_tel" maxlength="10"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
        ...
        <el-dialog :title="title" :visible.sync="repairModal" width="1024px">
            <el-form v-if="repairList.length" ref="forms" :model="repairList[0]" label-width="130px" style="padding-top: 20px">
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="维修项目名称:" prop="manufacturer">
                            <el-input disabled v-model.trim="repairList[0].device_name" maxlength="10"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="维修内容:" prop="costAmount">
                            <el-input v-model.trim="repairList[0].repair_content" maxlength="10"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
      ...
      <custom-upload-file-list-again :url="fileUrl" @close="close" :fileList='dataList' :upLoadQuery='upLoadQuery'></custom-upload-file-list-again>
        ...
        <el-dialog title="新增" :visible.sync="createModal" width="1100px">
            <custom-create @close="close" :searchList="searchList2" @listCreate="listCreate" :form="{}"></custom-create>
        </el-dialog>
        <el-dialog title="编辑" :visible.sync="editModal" width="1100px">
            <custom-edit @close="close" :searchList="searchList2" :form="multipleSelectionInfo" @listEdit="listEdit" :url="fileUrl"></custom-edit>
        </el-dialog>
...
export default {
    ...
    methods: {
        ...
        onUploadFile() {
            ...
            this.fileUrl = `${process.env.VUE_APP_API_URL}/common/uploadfile?infoType=t_training_device&&id=${this.dataList.id}`
        ...
        onExport() {
            ...
            window.open(`${process.env.VUE_APP_API_URL}/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_training_device`)
        },
        // 报废
        async onScrap() {
            if (!this.multipleSelection.length) {
