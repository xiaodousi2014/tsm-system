          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="地图名称:" prop="manufacturer">
                <el-input
                  disabled
                  v-model.trim="item.maps_name"
                  maxlength="10"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="请领数量:" prop="mapsModel">
                <el-input
       ...
       <div v-for="item in repairList" :key="item.id">
        ...
        >
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="报废数量:" prop="mapsModel">
                <el-input
                  v-model.trim="item.quantity"
                  maxlength="30"
                  @change="changeNumber($event,item)"
...
export default {
  ...
  methods: {
     getAttachFile(query) {
      ...
      Http.getAttachFile({id:query.row.id, infoType: "t_maps" , file: query.file})
      .then((res) => {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `http://139.198.188.175:8190/common/attachment/import?infoType=t_maps&id=${this.multipleSelection[0]}`;
    ...
    onExport() {
      ...
      window.open(`http://139.198.188.175:8190/common/attachment/export?ids=${this.multipleSelection.toString()}&&infoType=t_maps`)
    },
    // 报废
    // async onScrap() {
    //   if (!this.multipleSelection.length) {
