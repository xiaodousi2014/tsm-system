  ...
  <div class="bodyCommon">
    <div class="top-menu">
      ...
      <div class="top-menu-but">
        ...
        <el-button class="btnSty" @click="goPage(1)">任务分解</el-button>
        <el-button class="btnSty" @click="goPage(3)">任务导入</el-button>
        <el-button class="btnSty" @click="goPage(4)">经费报销登记</el-button>
        <el-button class="btnSty" @click="goPage(5)">成果</el-button>
        <el-button type="primary" class="btnWidth" style="padding:12px 0;">上传附件</el-button>
        <el-button type="primary" class="btnWidth" style="padding:12px 0;" @click="goPage(2)">删除记录</el-button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    goPage(flag) {
      if(flag==1){
        this.$router.push('/pm/progress-projcet-task')
      }else if(flag==2){
        this.$router.push('/pm/progress-projcet-delete')
      }else if(flag==3){
        this.$router.push('/pm/progress-projcet-import')
      }else if(flag==4){
        this.$router.push('/pm/progress-projcet-fund')
      }else if(flag==5){
        this.$router.push('/pm/progress-projcet-results')
      }
