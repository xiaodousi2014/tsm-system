...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: "http://10.8.145.43:8190/information/electronic/import",
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
    onTemplateDown() {
      window.open('http://10.8.145.43:8190/common/attachment/download_TemplateFile?infoType=t_information_electronic')
    },
     getAttachFile(query) {
   ...
   // 上传附件
    ...
    onUpload() {
      (this.fileUrl = "http://10.8.145.43:8190/information/electronic/import"),
