...
export default {
  ...
  data() {
    return {
      ...
      fileUrl: "http://139.198.188.175:8190/information/electronic/import",
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
    onTemplateDown() {
      window.open('http://139.198.188.175:8190/common/attachment/download_TemplateFile?infoType=t_information_electronic')
    },
     getAttachFile(query) {
   ...
   // 上传附件
    ...
    onUpload() {
      (this.fileUrl = "http://139.198.188.175:8190/information/electronic/import"),
