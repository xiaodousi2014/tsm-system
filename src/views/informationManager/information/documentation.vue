...
export default {
  ...
  data() {
    return {
      ...
      exportModal: false,
      searchModal: false,
      fileUrl: "http://10.8.145.43:8190/information/import",
    };
  },
  mounted() {
    this.getAllField();
  ...
  methods: {
    ...
    onUploadFile() {
      ...
      this.fileUrl = `http://10.8.145.43:8190/common/attachment/import?infoType=t_information&id=${this.multipleSelection[0]}`;
    ...
    onUpload() {
      (this.fileUrl = "http://10.8.145.43:8190/information/import"),
        (this.exportModal = true);
    },
    getAllField() {
