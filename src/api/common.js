...
export default {
    ...
    //查询列表
    queryMessage(params) {
        return Http.post(`${SERVICE_URL}/message/query`, params)
    },
    //查询数量 type:0-所有未读;1-通知;2-消息
    queryMessageCount(params) {
        return Http.get(`${SERVICE_URL}/message/count?type=${params}`)
    },
    updateMessage(params) {
        return Http.post(`${SERVICE_URL}/message`, params)
    }
}
